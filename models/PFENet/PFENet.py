...
import models.PFENet.resnet as models
import models.PFENet.vgg as vgg_models
...
if __name__ == "__main__":
    ...
    support_img = torch.rand(1, 1, 3, 256, 256).cuda()
    support_mask = torch.rand(1, 1, 256, 256).cuda()
    query_mask = torch.rand(1, 256, 256).cuda()
    output = model(query_img, support_img, support_mask, query_mask)
