...
import time
import cv2
import models.DCP.resnet as models
import models.DCP.vgg as vgg_models
from models.DCP.ASPP import ASPP, ASPP_Drop, ASPP_BN
...
class OneModel(nn.Module):
    def __init__(self, split=0, shot=1, cls_type=None):
    ...
    def get_optim(self, model, LR):
        optimizer = torch.optim.SGD(
            ...
            lr=LR, momentum=0.9, weight_decay=0.0001)  # 2.5e-3, 0.9, 1e-4
