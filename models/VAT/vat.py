...
from models.VAT.base.feature import extract_feat_vgg, extract_feat_res
from models.VAT.base.correlation import Correlation
from models.VAT.learner import VATLearner
from models.VAT.config import get_cfg_defaults

class VAT(nn.Module):
    def __init__(self, use_original_imgsize):
        super(VAT, self).__init__()
        cfg = get_cfg_defaults()
        cfg.merge_from_file(r'D:\IMSN-YHM\FS-defect\models\VAT\default.yaml')
        cfg.freeze()
